...
export default function Sidebar({ setDarkMode, darkMode, setCurrentTap }) {
  ...
  return (
    <aside
      className=" bg-bg-side flex lg:flex-col lg:h-screen lg:w-fit text-dark-li pt-3 lg:pt-0 px-2 lg:px-4
 flex-row h-[59px] w-screen justify-evenly"
    >
      ...
      <ul className="h-full gap-4 lg:my-8  flex lg:flex-col  items-center  flex-row w-full  justify-evenly text-li-clr ">
        <li title="profile" onClick={() => setCurrentTap("PROFILE")}>
        ...
        <li title="chats" onClick={() => setCurrentTap("CHATS")}>
          <button className="w-fit">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="27"
        ...
        <li title="settings" onClick={() => setCurrentTap("SETTINGS")}>
          <button
            className="w-fit 
           "
          >
